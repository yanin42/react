                                            ...
                                            <div className="box">
                                                ...
                                                >
                                                    <form className="container" id='form'>
                                                        ...
                                                        <div className="form-group">
                                                            <label>email1:</label>
                                                            <input type="text" className="form-control" id="email1" onChange={this.handleChang} value={this.state.email1}/>
                                                        </div>
                                                        <div className="form-group">
                                                            <label>date1:</label>
                                                            <input type="text" className="form-control" id="date1" onChange={this.handleChang} value={this.state.date1}/>
                                                        </div>
